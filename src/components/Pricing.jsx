...
function Pricing() {
    ...
    const styles = {
        ...
        purpleDiv: "flex flex-col items-center justify-top space-y-10 bg-[#8729FF] w-1/3 h-[400px] rounded-t-[3rem] p-10 reveal fade-left",
        ...
        centerDiv: "flex flex-col items-center justify-between bg-black w-1/3 h-[700px] rounded-t-[3rem] p-10 pb-0 reveal",
